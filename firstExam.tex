...
\section{Acoustic Properties of Language} \label{acoustics}
  ...
  One approach to tackling this problem is to abstract away from the level of languages
  and to deal with how the human brain processes speech sounds.
  ...
  and eventually processed by the same brain areas. So, what are the properties of human speech?
...
\section{Neural Representations of Speech} \label{higher}
  ...
  \subsection{Innate Brain Rhythms} \label{innateBrainRhythms}
    ...
    and $\gamma$ (30 - 80 Hz) \cite{Muresan2008,Rangaswamy2002}. These are roughly divided by
    ...
    can be divided into the syllables \textipa{/"wIn/} and \textipa{/doU/}. In the \textipa{/"wIn/}
    syllable, the \textipa{/I/} sound functions as the nucleus while the \textipa{/w/} and \textipa{/n/}
...
\section{Cortical Entrainment}
  ...
  \subsection{Phase Entrainment}
    ...
    carried in the speech signal by the brain. Zoefel and VanRullen \cite{Zoefel2016} address this
  ...
  \subsection{Envelope Following and Brain Rhythms}
    ...
    The fact that cortical neurons track the power envelope of speech signals is now well-known and
    is considered an important part of the speech processing pathway. But, the interaction between
    natural cortical rhythms (discussed in Section \ref{innateBrainRhythms}) and the envelope follwing
    response is still not completely understood. The most popular theory is currently that speech signals
    are essentially a quasi-rhythmic input signals and their envelope is tracked by a set of neurons in
    the cortex. This tracking then enables both the exclusion of irrelevant speech signals
  ...
  \subsection{Comprehension Effects of Entrainment}
    ...
    amplitude and frequency modulated with fundamental frequency $f_{AM}$.
